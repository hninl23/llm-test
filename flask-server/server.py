...
def process_pdf():
    ...
    if pdf_file is not None:
        ...
        try:
            ...
            print("Text splitter object is not a 'RecursiveCharacterTextSplitter' object", e )
        except Exception as e:
        ...
        try:
            ...
            print("Expected inputs [question, chat_history, context] not found", e )
        except Exception as e:
        ...
        try:
            ...
            qa = None
            print("Error: An unexpected error occurred while initializing ConversationalRetrievalChain.", e )
        ...
        try:
            if result["answer"] == "The information is not found in the PDF.":
                ...
                _chat_history.append({"question": question, "answer": result["answer"], "page": page_nums + 1})
